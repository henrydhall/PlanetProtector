...
class Meteor(pg.sprite.Sprite):
    ...
    def calculate_acceleration(self, planet: Planet) -> tuple[float, float]:
        ...
        TODO: account for the opposite and adjacent changing x or y depending on which quadrant we're in.
        """
        angle = math.atan( (self.rect.centerx - planet.rect.centerx) / (self.rect.centery-planet.rect.centery) )
        opposite = math.sin(angle) * ACCELERATION
        adjacent = math.cos(angle) * ACCELERATION
